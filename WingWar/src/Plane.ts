...
class Plane extends PhysicsState {
    ...
    public moveCalc(world: Game) {
        ...
        if (this.mesh && this.mesh.position) { this.mesh.position.copy(this.position); }
        if (this.mesh) { this.mesh.setRotationFromMatrix(CameraHelper.worldToView(this.matrix)) };
