...
class Wing extends PhysicsState {
    ...
    constructor() {
        ...
        //     -------->X
        // �ϐ�
        this.unitX = new THREE.Vector3(); // �����W�w�P�ʃx�N�g���i�@�̍��W�j
        this.unitY = new THREE.Vector3(); // �����W�x�P�ʃx�N�g���i�@�̍��W�j
        this.zVel = new THREE.Vector3(); // �����W�y�P�ʃx�N�g���i�@�̍��W�j
        this.fVel = new THREE.Vector3(); // ���ɂ������Ă����
    }
    // ���v�Z��s��
    // fVel�Ɍv�Z���ʂ����܂�
    // ve�͋�C���x�Ano�͗�No.�i�}�p�v�Z�Ɏg�p�j�Aboost�̓G���W���u�[�X�g
    calc(plane, ve, no, boost) {
        let cd, ff;
...
class Bullet extends PhysicsState {
    ...
    constructor(scene) {
        super();
        // �ϐ�
        this.oldPosition = new THREE.Vector3(); // �P�X�e�b�v�O�̈ʒu
...
class Missile extends PhysicsState {
    constructor(scene) {
        super();
        // �ϐ�
        this.oldPositions = []; // �̂̈ʒu�i���̈ʒu�j
        this.forward = new THREE.Vector3(); // �����i�P�ʃx�N�g���j
        this.use = 0; // �g�p��ԁi0�Ŗ��g�p�j
        this.bom = 0; // ������ԁi0�Ŗ����j
...
(function (AudioManager) {
    ...
    function init(camera) {
        ...
        audioLoader.load('sounds/PROP1.WAV', (buffer) => {
    ...
    AudioManager.getSound = getSound;
...
class Plane extends PhysicsState {
    ...
    constructor(scene) {
        ...
        this.localVelocity = new THREE.Vector3(); // �@�̑��x�i�@�̍��W�n�j
        this.gVel = new THREE.Vector3(); // �@�̉����x�i���[���h���W�n�j
        this.vaVel = new THREE.Vector3(); // �@�̉�]���x�i�I�C���[�p�j
        this.gcVel = new THREE.Vector3(); // �e�ۂ̏����\�z�ʒu
        this.iMass = new THREE.Vector3(); // �@�̊e���̊������[�����g
        // ���c�n
        this.stickPos = new THREE.Vector3(); // ���c�n�ʒu�ix,y-�X�e�B�b�N,z-�y�_���j
        this.stickVel = new THREE.Vector3(); // ���c�n�ω���
        this.stickR = 0.1; // ���c�n�̊��x (R-�Z���^�[�ւ̌�����)
        this.stickA = 0.06; //0.05;    // ���c�n�̊��x�iA-�ω����j
        // �@�e�n
        this.bullets = []; // �e�e�ۃI�u�W�F�N�g
        // �~�T�C���n
        ...
        loader.load('../models/a6m5.json', (geometry, materials) => {
            var faceMaterial = new THREE.MeshFaceMaterial(materials);
            this.mesh = new THREE.Mesh(geometry, faceMaterial);
            this.mesh.castShadow = true;
            scene.add(this.mesh);
            if (Plane.number === 0)
                this.mesh.add(AudioManager.getSound());
    ...
    lockCheck(world) {
        let a = new THREE.Vector3();
        let b = new THREE.Vector3();
        let nno = new Array(Plane.MMMAX); // �@��No.
        let dis = new Array(Plane.MMMAX); // �@�̂Ǝ��@�Ƃ̋���
...
class _Screen {
    ...
    drawLine(strokeStyle, x1, y1, x2, y2) {
        //短縮表現
    ...
    drawCircle(strokeStyle, centerX, centerY, radius) {
        const ctx = this.context;
        ctx.save();
        {
            ctx.beginPath();
    ...
    strokeRect(strokeStyle, x, y, w, h) {
    ...
    drawRoundRect(style, x, y, width, height, radius = 5, stroke = false) {
        let ctx = this.context;
...
class HUD extends _Screen {
    constructor(canvas, plane, world) {
        super(canvas);
        this.plane = plane;
        this.world = world;
    }
...
(function (Main) {
    ...
    function init() {
        ...
        AudioManager.init(Main.camera.getCamera());
        // RENDERER
